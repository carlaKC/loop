...
const (
	...
	LiquidityRuleType_RATIO   LiquidityRuleType = 1
)
...
type LiquidityConfig struct {
	...
	//
	//A rule to be applied across all of the channels on your node. Note that this
	//field cannot be set if peer rule is set.
	NodeRule *LiquidityRule `protobuf:"bytes,2,opt,name=node_rule,json=nodeRule,proto3" json:"node_rule,omitempty"`
	//
	//A rule to be applier per peer that your node has channels open with. Note
	//that this field cannot be set if node rule is set.
	PeerRule             *LiquidityRule `protobuf:"bytes,3,opt,name=peer_rule,json=peerRule,proto3" json:"peer_rule,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
func (m *LiquidityConfig) GetNodeRule() *LiquidityRule {
	if m != nil {
		return m.NodeRule
	}
	return nil
...
func (m *LiquidityConfig) GetPeerRule() *LiquidityRule {
	if m != nil {
		return m.PeerRule
	}
	return nil
...
type LiquidityRule struct {
	...
	//
	//RATIO: Minimum inbound is the minimum inbound ratio beneath which loop outs
	//to acquire inbound liquidity will be recommended when using the ratio rule.
	MinimumInbound float32 `protobuf:"fixed32,2,opt,name=minimum_inbound,json=minimumInbound,proto3" json:"minimum_inbound,omitempty"`
	//
	//RATIO: Minimum outbound is the minimum outbound ratio beneath which loop ins
	//to acquire outbound liquidity will be recommended when using the ratio rule.
	MinimumOutbound      float32  `protobuf:"fixed32,3,opt,name=minimum_outbound,json=minimumOutbound,proto3" json:"minimum_outbound,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *LiquidityRule) GetMinimumInbound() float32 {
	if m != nil {
...
func (m *LiquidityRule) GetMinimumOutbound() float32 {
	if m != nil {
...
type SuggestSwapsResponse struct {
	//
	//Rule is the rule that was applied to get these swap recommendations.
	Rule *LiquidityRule `protobuf:"bytes,1,opt,name=rule,proto3" json:"rule,omitempty"`
	//
	//The set of swaps that are suggested to conform to the rule provided.
	Swaps                []*SwapSuggestion `protobuf:"bytes,2,rep,name=swaps,proto3" json:"swaps,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *SuggestSwapsResponse) GetRule() *LiquidityRule {
	if m != nil {
		return m.Rule
	}
	return nil
...
func (m *SuggestSwapsResponse) GetSwaps() []*SwapSuggestion {
	if m != nil {
		return m.Swaps
	}
	return nil
...
type SwapSuggestion struct {
	//
	//The action that is recommended based on current balances and config.
	//TODO(carla): make this an enum.
	Action string `protobuf:"bytes,1,opt,name=action,proto3" json:"action,omitempty"`
	//
	//Additional reasoning to accompany our action.
	//TODO(carla): make this an enum
	Reason string `protobuf:"bytes,2,opt,name=reason,proto3" json:"reason,omitempty"`
	//
	//The set of swaps that we suggest.
	Swaps                []*SwapParameters `protobuf:"bytes,3,rep,name=swaps,proto3" json:"swaps,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *SwapSuggestion) GetAction() string {
	if m != nil {
		return m.Action
	}
	return ""
...
func (m *SwapSuggestion) GetReason() string {
	if m != nil {
		return m.Reason
	}
	return ""
...
func (m *SwapSuggestion) GetSwaps() []*SwapParameters {
	if m != nil {
		return m.Swaps
	}
	return nil
...
type SwapParameters struct {
	// The channel ID that the swap should be restricted to.
	ChannelId uint64 `protobuf:"varint,1,opt,name=channel_id,json=channelId,proto3" json:"channel_id,omitempty"`
	// The amount that should be swapped.
	Amount uint64 `protobuf:"varint,2,opt,name=amount,proto3" json:"amount,omitempty"`
	// The type of swap that should be executed.
	SwapType             SwapType `protobuf:"varint,3,opt,name=swap_type,json=swapType,proto3,enum=looprpc.SwapType" json:"swap_type,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *SwapParameters) Reset()         { *m = SwapParameters{} }
func (m *SwapParameters) String() string { return proto.CompactTextString(m) }
func (*SwapParameters) ProtoMessage()    {}
func (*SwapParameters) Descriptor() ([]byte, []int) {
	return fileDescriptor_014de31d7ac8c57c, []int{24}
}

func (m *SwapParameters) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_SwapParameters.Unmarshal(m, b)
}
func (m *SwapParameters) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_SwapParameters.Marshal(b, m, deterministic)
}
func (m *SwapParameters) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SwapParameters.Merge(m, src)
}
func (m *SwapParameters) XXX_Size() int {
	return xxx_messageInfo_SwapParameters.Size(m)
}
func (m *SwapParameters) XXX_DiscardUnknown() {
	xxx_messageInfo_SwapParameters.DiscardUnknown(m)
}

var xxx_messageInfo_SwapParameters proto.InternalMessageInfo

func (m *SwapParameters) GetChannelId() uint64 {
	if m != nil {
		return m.ChannelId
	}
	return 0
...
func (m *SwapParameters) GetAmount() uint64 {
	if m != nil {
		return m.Amount
	}
	return 0
...
func (m *SwapParameters) GetSwapType() SwapType {
	if m != nil {
		return m.SwapType
	}
	return SwapType_LOOP_OUT
...
func init() {
	...
	proto.RegisterType((*SwapParameters)(nil), "looprpc.SwapParameters")
}
...
var fileDescriptor_014de31d7ac8c57c = []byte{
	...
	,
}
...
type SwapClientClient interface {
	...
	SetLiquidityConfig(ctx context.Context, in *SetLiquidityConfigRequest, opts ...grpc.CallOption) (*LiquidityConfig, error)
	//
	//SuggestSwaps returns a list of recommended swaps based on the current
	//state of your node's channels and the autolooper configuration set.
...
func (c *swapClientClient) SetLiquidityConfig(ctx context.Context, in *SetLiquidityConfigRequest, opts ...grpc.CallOption) (*LiquidityConfig, error) {
	out := new(LiquidityConfig)
...
type SwapClientServer interface {
	...
	//SetLiquidityConfig sets a new config for the liquidity manager subsystem.
	//It returns the config that has been applied.
	SetLiquidityConfig(context.Context, *SetLiquidityConfigRequest) (*LiquidityConfig, error)
	//
	//SuggestSwaps returns a list of recommended swaps based on the current
	//state of your node's channels and the autolooper configuration set.
...
func (*UnimplementedSwapClientServer) SetLiquidityConfig(ctx context.Context, req *SetLiquidityConfigRequest) (*LiquidityConfig, error) {
