...
type LiquidityParameters struct {
	...
	//
	//The maximum fee in paid to the server for facilitating the swap, expressed
	//as parts per million of the swap volume, swap suggestions with fees higher
	//than this will be excluded.
	MaxSwapFeePpm uint64 `protobuf:"varint,2,opt,name=max_swap_fee_ppm,json=maxSwapFeePpm,proto3" json:"max_swap_fee_ppm,omitempty"`
	//
	//The maximum no-show penalty in satoshis paid for a swap, swap suggestions
	//above this amount will be excluded.
	MaxPrepay uint64 `protobuf:"varint,3,opt,name=max_prepay,json=maxPrepay,proto3" json:"max_prepay,omitempty"`
	//
	//The maximum miner fee for a swap in satoshis, swap suggestions above this
	//amount will be excluded.
	MaxMinerFee uint64 `protobuf:"varint,4,opt,name=max_miner_fee,json=maxMinerFee,proto3" json:"max_miner_fee,omitempty"`
	//
	//The number of blocks from the on-chain HTLC's confirmation height that it
	//should be swept within.
	SweepConfTarget int32 `protobuf:"varint,5,opt,name=sweep_conf_target,json=sweepConfTarget,proto3" json:"sweep_conf_target,omitempty"`
	//
	//The amount of time we require pass since a channel was part of a failed
	//swap until it will be considered for swap suggestions again, expressed in
	//seconds.
	FailureBackoff       uint64   `protobuf:"varint,6,opt,name=failure_backoff,json=failureBackoff,proto3" json:"failure_backoff,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *LiquidityParameters) GetMaxPrepay() uint64 {
	if m != nil {
		return m.MaxPrepay
	}
	return 0
...
func (m *LiquidityParameters) GetMaxMinerFee() uint64 {
	if m != nil {
		return m.MaxMinerFee
	}
	return 0
...
func (m *LiquidityParameters) GetFailureBackoff() uint64 {
	if m != nil {
...
var fileDescriptor_014de31d7ac8c57c = []byte{
	...
	,
}
